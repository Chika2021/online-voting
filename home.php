	...
	<?php include 'includes/navbar.php'; ?>
  	...
  	<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
	      ...
	      <section class="content">
	      	...
	      	<h1 class="page-header text-center title"><b> Welcome to 2023 AIT Election </b></h1>
	        <div class="row">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">SECURITY WARNINGS</h5>
...
<div class="modal fade" id="myModal1" role="dialog" style="z-index: 9999;">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-body">
        <h4><span>SECURITY WARNING</span></h4> 
          <small>Please do not expose your security details to an external source.</small>
		  <small>Logout your account imidatley after any login</small>
		  <small>Contact your administration if any issues is faced</small>
...
<script>
 $( document ).ready(function(){
   ...
   setTimeout(function() {$('#myModal1').modal('hide');}, 100000);
});
  </script>
